...
- 조사 과정에서 Netlify, GitHub Pages 등의 배포 서비스가 기본적으로 CDN 기능을 제공한다는 점 발견
...
- package.json의 버전 정보를 읽어 해당 버전의 디렉토리를 생성합니다.
